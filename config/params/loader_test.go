...
//		}
//		mainnetConfigFile := "config/params/testdata/configs/mainnet.yaml"
...
//			params.LoadChainConfigFile(fp, nil)
//		}
//		minimalConfigFile := "config/params/testdata/configs/minimal.yaml"
...
//			params.LoadChainConfigFile(fp, nil)
//		}
//		configFile := "config/params/testdata/e2e_config.yaml"
...
func presetsFilePath(t *testing.T, config string) []string {
	//filepath, err := bazel.Runfile("external/consensus_spec")
	//require.NoError(t, err)
	//testsFolderPath := path.Join("config/params/testdata", config)
	//filepath, err := bazel.Runfile(testsFolderPath)
	//require.NoError(t, err)
	//testFolders, err := ioutil.ReadDir(filepath)
	//testFolders, err := ioutil.ReadDir(testsFolderPath)
	//require.NoError(t, err)
	...
	return []string{
		path.Join("config/params/testdata", "presets", config, "phase0.yaml"),
		path.Join("config/params/testdata", "presets", config, "altair.yaml"),
	}
}
