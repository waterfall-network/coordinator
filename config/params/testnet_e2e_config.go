...
func E2ETestConfig() *BeaconChainConfig {
	...
	e2eConfig.CleanWithdrawalsAftEpochs = 100
	...
	// PoW parameters.
	e2eConfig.DepositChainID = 337733   // Chain ID of eth1 dev net.
	e2eConfig.DepositNetworkID = 337733 // Network ID of eth1 dev net.
