...
def prysm_deps():
    ...
    go_repository(
        ...
        sum = "h1:XEcumY+qSr1cZQaWsQs5Kck3FHB0V2RiMHPdTBJ+oT8=",
        version = "v1.10.17",
    )
    ...
    go_repository(
        ...
        sum = "h1:uOKW26NG1hsSSbXIZ1IR7XP9Gjd1U8pnLaCMgntmkmY=",
        version = "v1.2.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:iiZslO5byUYZEg9iCwJGf5h+sf1Agmqx2V2FDjPyvUw=",
        version = "v0.3.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:HghtFrWyZEPrpTvgAMFJi6gFdgHfs2cb0pyfDsk+lqU=",
        version = "v0.10.1",
    )
    go_repository(
    ...
    #        sum = "h1:ZX/UNQ4gvpCv2RmwdbA6lrRjF6EBm5yZ7TMoT4NQVrA=",
    #        version = "v0.36.2",
    #    )
    #    go_repository(
    #        name = "com_github_quic_go_webtransport_go",
    #        importpath = "github.com/quic-go/webtransport-go",
    #        sum = "h1:5XMlzemqB4qmOlgIus5zB45AcZ2kCgCy2EptUrfOPWU=",
    #        version = "v0.5.3",
    #    )
    ...
    go_repository(
        ...
        sum = "h1:5EHSbj8wBDJP3kI3DxczgLn/3/GcjX8CvfW2mXWzdZE=",
        version = "v0.7.26",
