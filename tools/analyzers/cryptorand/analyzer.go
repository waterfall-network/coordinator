...
var errWeakCrypto = errors.New("crypto-secure RNGs are required, use CSPRNG or PRNG defined in gitlab.waterfall.network/waterfall/protocol/coordinator/crypto/rand")
