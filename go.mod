...
require (
	...
	gitlab.waterfall.network/waterfall/protocol/gwat v0.7.26
...
replace gitlab.waterfall.network/waterfall/protocol/gwat => /Users/who/Documents/projects/waterfall/gitlab/gwat
