...
func TestGetParentByOptimisticSpines_TwoBranches(t *testing.T) {
	...
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 0, nrToHash(0), params.BeaconConfig().ZeroHash, 0, 0, justifiedRoot[:], finalizedRoot[:], nil, nil, nil))
	...
	// Left branch.
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 1, nrToHash(1), nrToHash(0), 0, 0, justifiedRoot[:], finalizedRoot[:], nil, nil, nil))
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 2, nrToHash(3), nrToHash(1), 1, 0, justifiedRoot[:], finalizedRoot[:], nil, nil, nil))
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 3, nrToHash(5), nrToHash(3), 1, 0, justifiedRoot[:], finalizedRoot[:], nil, nil, nil))
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 4, nrToHash(7), nrToHash(5), 1, 0, justifiedRoot[:], finalizedRoot[:], nil, nil, nil))
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 4, nrToHash(9), nrToHash(7), 2, 0, justifiedRoot[:], finalizedRoot[:], nil, nil, nil))
	// Right branch.
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 1, nrToHash(2), nrToHash(0), 0, 0, justifiedRoot[:], finalizedRoot[:], nil, nil, nil))
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 2, nrToHash(4), nrToHash(2), 0, 0, justifiedRoot[:], finalizedRoot[:], nil, nil, nil))
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 3, nrToHash(6), nrToHash(4), 0, 0, justifiedRoot[:], finalizedRoot[:], nil, nil, nil))
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 4, nrToHash(8), nrToHash(6), 1, 0, justifiedRoot[:], finalizedRoot[:], nil, nil, nil))
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 4, nrToHash(10), nrToHash(8), 2, 0, justifiedRoot[:], finalizedRoot[:], nil, nil, nil))
