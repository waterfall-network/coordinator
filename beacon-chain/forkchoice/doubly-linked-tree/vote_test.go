...
func TestVotes_CanFindHead(t *testing.T) {
	...
	//        /
	//       2 <- head
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 0, indexToHash(2), params.BeaconConfig().ZeroHash, 1, 1, params.BeaconConfig().ZeroHash[:], params.BeaconConfig().ZeroHash[:], nil))
	...
	//           / \
	//  head -> 2  1
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 0, indexToHash(1), params.BeaconConfig().ZeroHash, 1, 1, params.BeaconConfig().ZeroHash[:], params.BeaconConfig().ZeroHash[:], nil))
	...
	//             |
	//             3
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 0, indexToHash(3), indexToHash(1), 1, 1, params.BeaconConfig().ZeroHash[:], params.BeaconConfig().ZeroHash[:], nil))
	...
	//             |
	//             4 <- head
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 0, indexToHash(4), indexToHash(3), 1, 1, params.BeaconConfig().ZeroHash[:], params.BeaconConfig().ZeroHash[:], nil))
	...
	//            /
	//           5 <- justified epoch = 2
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 0, indexToHash(5), indexToHash(4), 2, 2, params.BeaconConfig().ZeroHash[:], params.BeaconConfig().ZeroHash[:], nil))
	...
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 0, indexToHash(6), indexToHash(4), 1, 1, params.BeaconConfig().ZeroHash[:], params.BeaconConfig().ZeroHash[:], nil))
	...
	//           |
	//           9
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 0, indexToHash(7), indexToHash(5), 2, 2, params.BeaconConfig().ZeroHash[:], params.BeaconConfig().ZeroHash[:], nil))
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 0, indexToHash(8), indexToHash(7), 2, 2, params.BeaconConfig().ZeroHash[:], params.BeaconConfig().ZeroHash[:], nil))
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 0, indexToHash(9), indexToHash(8), 2, 2, params.BeaconConfig().ZeroHash[:], params.BeaconConfig().ZeroHash[:], nil))
	...
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 0, indexToHash(10), indexToHash(8), 2, 2, params.BeaconConfig().ZeroHash[:], params.BeaconConfig().ZeroHash[:], nil))
	...
	//        |
	// head-> 11
	require.NoError(t, f.InsertOptimisticBlock(context.Background(), 0, indexToHash(11), indexToHash(9), 2, 2, params.BeaconConfig().ZeroHash[:], params.BeaconConfig().ZeroHash[:], nil))
