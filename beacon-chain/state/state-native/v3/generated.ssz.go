...
// Hash: 28df78acb023623f895f73ee7a0e7f84fa2d5c744c6e564ac63b698e511e727a
package v3
...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.spineData == nil {
		b.spineData = new(ethpb.SpineData)
	}
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o8, o9, o11, o12, o13, o16, o17, o22, o23, o26 uint64
	...
	// Offset (23) 'inactivityScores'
	if o23 = ssz.ReadOffset(buf[2687317:2687321]); o23 > size || o22 > o23 {
		return ssz.ErrOffset
	}
