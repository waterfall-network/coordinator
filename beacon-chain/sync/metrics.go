...
func (s *Service) updateMetrics() {
	...
	indices := s.aggregatorSubnetIndices(s.cfg.chain.CurrentSlot())                            //nolint
	syncIndices := cache.SyncSubnetIDs.GetAllSubnets(slots.ToEpoch(s.cfg.chain.CurrentSlot())) // nolint
