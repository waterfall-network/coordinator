...
import (
	...
	p2pm "gitlab.waterfall.network/waterfall/protocol/coordinator/beacon-chain/p2p"
	p2pt "gitlab.waterfall.network/waterfall/protocol/coordinator/beacon-chain/p2p/testing"
