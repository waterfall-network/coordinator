...
## Contributing
We have put all of our contribution guidelines into [CONTRIBUTING.md](https://github.com/waterfall-foundation/coordinator/blob/master/CONTRIBUTING.md)! Check it out to get started.