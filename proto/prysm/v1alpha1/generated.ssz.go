...
// Hash: 9accde3d4f573d602517a7b09649a477454630043db043c054d1199e839e1453
package eth
...
func (b *BlockVoting) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (1) 'TotalAttesters'
	dst = ssz.MarshalUint64(dst, b.TotalAttesters)
...
func (b *BlockVoting) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'TotalAttesters'
	b.TotalAttesters = ssz.UnmarshallUint64(buf[32:40])
