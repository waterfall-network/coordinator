...
// Hash: ee11a033357e2d62a435db8b12989344394c1af7e32b73fcdde0f607d3218ed3
package eth
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	for ii := 0; ii < 65536; ii++ {
		if cap(b.RandaoMixes[ii]) == 0 {
			b.RandaoMixes[ii] = make([]byte, 0, len(buf[524496:2621648][ii*32:(ii+1)*32]))
		}
		b.RandaoMixes[ii] = append(b.RandaoMixes[ii], buf[524496:2621648][ii*32:(ii+1)*32]...)
	}
...
func (b *BeaconStateBellatrix) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (25) 'LatestExecutionPayloadHeader'
	dst = ssz.WriteOffset(dst, offset)
	...
	// Field (25) 'LatestExecutionPayloadHeader'
...
func (b *BeaconStateBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o8, o9, o11, o12, o13, o16, o17, o22, o25 uint64
	...
	// Offset (25) 'LatestExecutionPayloadHeader'
	if o25 = ssz.ReadOffset(buf[2736565:2736569]); o25 > size || o22 > o25 {
		return ssz.ErrOffset
	}
