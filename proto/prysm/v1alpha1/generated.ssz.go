...
// Hash: aa509c9d20b04300c455885685f52b841b5af4b689f228fbec9a5776859b30ac
package eth
...
// MarshalSSZ ssz marshals the PreVoteData object
func (p *PreVoteData) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(p)
}

// MarshalSSZTo ssz marshals the PreVoteData object to a target array
func (p *PreVoteData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(20)
	...
	dst = append(dst, p.Candidates...)

	return
}

// UnmarshalSSZ ssz unmarshals the PreVoteData object
func (p *PreVoteData) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 20 {
		return ssz.ErrSize
	...
	// Field (1) 'Index'
	p.Index = github_com_prysmaticlabs_eth2_types.CommitteeIndex(ssz.UnmarshallUint64(buf[8:16]))
	...
	// Field (2) 'Candidates'
	{
		...
		if cap(p.Candidates) == 0 {
			p.Candidates = make([]byte, 0, len(buf))
		}
		p.Candidates = append(p.Candidates, buf...)
	}
	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the PreVoteData object
func (p *PreVoteData) SizeSSZ() (size int) {
	size = 20

	// Field (2) 'Candidates'
	size += len(p.Candidates)

	return
}

// HashTreeRoot ssz hashes the PreVoteData object
func (p *PreVoteData) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(p)
}

// HashTreeRootWith ssz hashes the PreVoteData object with a hasher
func (p *PreVoteData) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(p.Candidates))
		if byteLen > 4096 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.PutBytes(p.Candidates)
...
// MarshalSSZ ssz marshals the PreVote object
func (p *PreVote) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(p)
}

// MarshalSSZTo ssz marshals the PreVote object to a target array
func (p *PreVote) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(104)
...
// UnmarshalSSZ ssz unmarshals the PreVote object
func (p *PreVote) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 104 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the PreVote object
func (p *PreVote) SizeSSZ() (size int) {
	size = 104
...
// HashTreeRoot ssz hashes the PreVote object
func (p *PreVote) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(p)
}

// HashTreeRootWith ssz hashes the PreVote object with a hasher
func (p *PreVote) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
func (v *Validator) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	offset += len(v.WithdrawalOps) * 48

	// Field (11) 'WithdrawalOps'
	if len(v.WithdrawalOps) > 49152 {
		err = ssz.ErrListTooBig
		return
	}
...
func (v *Validator) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o11:]
		num, err := ssz.DivideInt2(len(buf), 48, 49152)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = v.WithdrawalOps[ii].UnmarshalSSZ(buf[ii*48 : (ii+1)*48]); err != nil {
				return err
			}
		}
	}
...
func (v *Validator) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (11) 'WithdrawalOps'
	{
		...
		hh.MerkleizeWithMixin(subIndx, num, 49152)
	}
...
func (w *WithdrawalOp) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Slot'
	dst = ssz.MarshalUint64(dst, uint64(w.Slot))
...
func (w *WithdrawalOp) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Slot'
	w.Slot = github_com_prysmaticlabs_eth2_types.Slot(ssz.UnmarshallUint64(buf[40:48]))
