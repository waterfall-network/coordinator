...
// Hash: 7126c80e4ff6ff1180cfe6ad7ed32021629b5a05fcb8c7761a0409208f5275bd
package eth
...
func (b *BeaconBlockBody) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o8:]
		num, err := ssz.DivideInt2(len(buf), 24, 16)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.Withdrawals[ii].UnmarshalSSZ(buf[ii*24 : (ii+1)*24]); err != nil {
				return err
			}
		}
	}
...
func (w *Withdrawal) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Epoch'
	w.Epoch = github_com_prysmaticlabs_eth2_types.Epoch(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'ValidatorIndex'
	w.ValidatorIndex = github_com_prysmaticlabs_eth2_types.ValidatorIndex(ssz.UnmarshallUint64(buf[8:16]))

	// Field (2) 'Amount'
	w.Amount = ssz.UnmarshallUint64(buf[16:24])
