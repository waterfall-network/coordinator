...
// Hash: 4e3516068ec125999fb77206180e22b4359dc1e36356a440d7dc9f42893f16ad
package eth
...
func (b *BeaconBlockBody) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o6:o7]
		num, err := ssz.DivideInt2(len(buf), 1248, 16)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.Deposits[ii].UnmarshalSSZ(buf[ii*1248 : (ii+1)*1248]); err != nil {
				return err
			}
		}
	}
...
func (d *Deposit) UnmarshalSSZ(buf []byte) error {
	...
	if err = d.Data.UnmarshalSSZ(buf[1056:1248]); err != nil {
		return err
	}
