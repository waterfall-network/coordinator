...
// Hash: fe6e15a779c16fbafcab47f298482c75a0e1b93921d8489f74c3b5ccbcfcdb55
package eth
...
func (e *Eth1Data) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (4) 'Finalization'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(e.Finalization)
	...
	// Field (4) 'Finalization'
	if len(e.Finalization) > 4096 {
		err = ssz.ErrBytesLength
		return
	}
	dst = append(dst, e.Finalization...)
...
func (e *Eth1Data) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (4) 'Finalization'
	if o4 = ssz.ReadOffset(buf[76:80]); o4 > size || o3 > o4 {
		return ssz.ErrOffset
	}
	...
	// Field (4) 'Finalization'
	{
		...
		if cap(e.Finalization) == 0 {
			e.Finalization = make([]byte, 0, len(buf))
		}
		e.Finalization = append(e.Finalization, buf...)
	}
	return err
}
...
func (e *Eth1Data) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(e.Finalization))
		if byteLen > 4096 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.PutBytes(e.Finalization)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (4096+31)/32)
	}
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o8, o9, o11, o12, o15, o16 uint64
	...
	for ii := 0; ii < 65536; ii++ {
		if cap(b.RandaoMixes[ii]) == 0 {
			b.RandaoMixes[ii] = make([]byte, 0, len(buf[524492:2621644][ii*32:(ii+1)*32]))
		}
		b.RandaoMixes[ii] = append(b.RandaoMixes[ii], buf[524492:2621644][ii*32:(ii+1)*32]...)
	}

	// Field (14) 'Slashings'
	b.Slashings = ssz.ExtendUint64(b.Slashings, 8192)
	for ii := 0; ii < 8192; ii++ {
		b.Slashings[ii] = ssz.UnmarshallUint64(buf[2621644:2687180][ii*8 : (ii+1)*8])
	}

	// Offset (15) 'PreviousEpochAttestations'
	if o15 = ssz.ReadOffset(buf[2687180:2687184]); o15 > size || o12 > o15 {
		return ssz.ErrOffset
	}

	// Offset (16) 'CurrentEpochAttestations'
	if o16 = ssz.ReadOffset(buf[2687184:2687188]); o16 > size || o15 > o16 {
		return ssz.ErrOffset
	}

	// Field (17) 'JustificationBits'
	if cap(b.JustificationBits) == 0 {
		b.JustificationBits = make([]byte, 0, len(buf[2687188:2687189]))
	}
	b.JustificationBits = append(b.JustificationBits, buf[2687188:2687189]...)

	// Field (18) 'PreviousJustifiedCheckpoint'
	if b.PreviousJustifiedCheckpoint == nil {
		b.PreviousJustifiedCheckpoint = new(Checkpoint)
	}
	if err = b.PreviousJustifiedCheckpoint.UnmarshalSSZ(buf[2687189:2687229]); err != nil {
		return err
	}
	...
	if err = b.CurrentJustifiedCheckpoint.UnmarshalSSZ(buf[2687229:2687269]); err != nil {
		return err
	}
	...
	if err = b.FinalizedCheckpoint.UnmarshalSSZ(buf[2687269:2687309]); err != nil {
		return err
	}
...
func (b *BeaconStateAltair) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o8, o9, o11, o12, o15, o16, o21 uint64
	...
	// Offset (21) 'InactivityScores'
	if o21 = ssz.ReadOffset(buf[2687309:2687313]); o21 > size || o16 > o21 {
		return ssz.ErrOffset
	}
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2687313:2711937]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[2711937:2736561]); err != nil {
		return err
	}
...
func (b *BeaconStateBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o7, o8, o9, o11, o12, o15, o16, o21, o24 uint64
	...
	// Offset (24) 'LatestExecutionPayloadHeader'
	if o24 = ssz.ReadOffset(buf[2736561:2736565]); o24 > size || o21 > o24 {
		return ssz.ErrOffset
	}
