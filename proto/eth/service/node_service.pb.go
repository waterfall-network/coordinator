...
var file_proto_eth_service_node_service_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x42, 0xa7, 0x01, 0x0a, 0x18, 0x6f, 0x72, 0x67, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72,
	...
	0x6f, 0x50, 0x01, 0x5a, 0x49, 0x67, 0x69, 0x74, 0x6c, 0x61, 0x62, 0x2e, 0x77, 0x61, 0x74, 0x65,
...
type BeaconNodeClient interface {
	...
	GetSyncStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v1.SyncingResponse, error)
...
func (c *beaconNodeClient) GetSyncStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v1.SyncingResponse, error) {
...
type BeaconNodeServer interface {
	...
	GetSyncStatus(context.Context, *emptypb.Empty) (*v1.SyncingResponse, error)
...
func (*UnimplementedBeaconNodeServer) GetSyncStatus(context.Context, *emptypb.Empty) (*v1.SyncingResponse, error) {
