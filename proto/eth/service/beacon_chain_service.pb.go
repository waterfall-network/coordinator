...
var file_proto_eth_service_beacon_chain_service_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xc0, 0x26, 0x0a, 0x0b, 0x42, 0x65, 0x61, 0x63,
	...
	,
	...
	0x63, 0x6b, 0x5f, 0x69, 0x64, 0x7d, 0x12, 0x7f, 0x0a, 0x0b, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74,
	0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x2d, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d,
	...
	0x65, 0x72, 0x56, 0x32, 0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
...
var file_proto_eth_service_beacon_chain_service_proto_depIdxs = []int32{
	...
	8,  // 11: ethereum.eth.service.BeaconChain.ListEth1Data:input_type -> ethereum.eth.v1.StateEth1DataRequest
	...
	30, // 44: ethereum.eth.service.BeaconChain.ListEth1Data:output_type -> ethereum.eth.v1.StateEth1DataResponse
...
type BeaconChainClient interface {
	...
	ListEth1Data(ctx context.Context, in *v1.StateEth1DataRequest, opts ...grpc.CallOption) (*v1.StateEth1DataResponse, error)
...
func (c *beaconChainClient) ListEth1Data(ctx context.Context, in *v1.StateEth1DataRequest, opts ...grpc.CallOption) (*v1.StateEth1DataResponse, error) {
	out := new(v1.StateEth1DataResponse)
	err := c.cc.Invoke(ctx, "/ethereum.eth.service.BeaconChain/ListEth1Data", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BeaconChainServer interface {
	...
	ListEth1Data(context.Context, *v1.StateEth1DataRequest) (*v1.StateEth1DataResponse, error)
...
func (*UnimplementedBeaconChainServer) ListEth1Data(context.Context, *v1.StateEth1DataRequest) (*v1.StateEth1DataResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListEth1Data not implemented")
}
...
func _BeaconChain_ListEth1Data_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v1.StateEth1DataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BeaconChainServer).ListEth1Data(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ethereum.eth.service.BeaconChain/ListEth1Data",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BeaconChainServer).ListEth1Data(ctx, req.(*v1.StateEth1DataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _BeaconChain_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListEth1Data",
			Handler:    _BeaconChain_ListEth1Data_Handler,
		},
		{
