...
var file_proto_eth_v1_beacon_state_proto_rawDesc = []byte{
	...
	0x22, 0x8e, 0x0c, 0x0a, 0x0b, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	0x74, 0x22, 0xc7, 0x01, 0x0a, 0x0b, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x56, 0x6f, 0x74, 0x69, 0x6e,
	0x67, 0x12, 0x1a, 0x0a, 0x04, 0x72, 0x6f, 0x6f, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x42,
	0x06, 0x8a, 0xb5, 0x18, 0x02, 0x33, 0x32, 0x52, 0x04, 0x72, 0x6f, 0x6f, 0x74, 0x12, 0x27, 0x0a,
	0x0f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x65, 0x72, 0x73,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0e, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x41, 0x74, 0x74,
	0x65, 0x73, 0x74, 0x65, 0x72, 0x73, 0x12, 0x28, 0x0a, 0x0a, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64,
	...
	0x42, 0x87, 0x01, 0x0a, 0x13, 0x6f, 0x72, 0x67, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75,
	0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x42, 0x10, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e,
	0x53, 0x74, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x38, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x77, 0x61, 0x74, 0x65, 0x72, 0x66, 0x61,
	0x6c, 0x6c, 0x2d, 0x66, 0x6f, 0x75, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x63, 0x6f,
...
var file_proto_eth_v1_beacon_state_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_proto_eth_v1_beacon_state_proto_goTypes = []interface{}{
	(*BeaconState)(nil),             // 0: ethereum.eth.v1.BeaconState
	(*BlockVoting)(nil),             // 1: ethereum.eth.v1.BlockVoting
	(*PendingAttestation)(nil),      // 2: ethereum.eth.v1.PendingAttestation
	(*Committee)(nil),               // 3: ethereum.eth.v1.Committee
	(*Fork)(nil),                    // 4: ethereum.eth.v1.Fork
	(*ForkChoiceHeadsResponse)(nil), // 5: ethereum.eth.v1.ForkChoiceHeadsResponse
	(*ForkChoiceHead)(nil),          // 6: ethereum.eth.v1.ForkChoiceHead
	(*BeaconStateResponse)(nil),     // 7: ethereum.eth.v1.BeaconStateResponse
	(*BeaconStateSSZResponse)(nil),  // 8: ethereum.eth.v1.BeaconStateSSZResponse
	(*BeaconBlockHeader)(nil),       // 9: ethereum.eth.v1.BeaconBlockHeader
	(*Eth1Data)(nil),                // 10: ethereum.eth.v1.Eth1Data
	(*Validator)(nil),               // 11: ethereum.eth.v1.Validator
	(*Checkpoint)(nil),              // 12: ethereum.eth.v1.Checkpoint
	(*Attestation)(nil),             // 13: ethereum.eth.v1.Attestation
	(*AttestationData)(nil),         // 14: ethereum.eth.v1.AttestationData
}
var file_proto_eth_v1_beacon_state_proto_depIdxs = []int32{
	4,  // 0: ethereum.eth.v1.BeaconState.fork:type_name -> ethereum.eth.v1.Fork
	9,  // 1: ethereum.eth.v1.BeaconState.latest_block_header:type_name -> ethereum.eth.v1.BeaconBlockHeader
	10, // 2: ethereum.eth.v1.BeaconState.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	10, // 3: ethereum.eth.v1.BeaconState.eth1_data_votes:type_name -> ethereum.eth.v1.Eth1Data
	1,  // 4: ethereum.eth.v1.BeaconState.block_voting:type_name -> ethereum.eth.v1.BlockVoting
	11, // 5: ethereum.eth.v1.BeaconState.validators:type_name -> ethereum.eth.v1.Validator
	2,  // 6: ethereum.eth.v1.BeaconState.previous_epoch_attestations:type_name -> ethereum.eth.v1.PendingAttestation
	2,  // 7: ethereum.eth.v1.BeaconState.current_epoch_attestations:type_name -> ethereum.eth.v1.PendingAttestation
	12, // 8: ethereum.eth.v1.BeaconState.previous_justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	12, // 9: ethereum.eth.v1.BeaconState.current_justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	12, // 10: ethereum.eth.v1.BeaconState.finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	13, // 11: ethereum.eth.v1.BlockVoting.attestations:type_name -> ethereum.eth.v1.Attestation
	14, // 12: ethereum.eth.v1.PendingAttestation.data:type_name -> ethereum.eth.v1.AttestationData
	6,  // 13: ethereum.eth.v1.ForkChoiceHeadsResponse.data:type_name -> ethereum.eth.v1.ForkChoiceHead
	0,  // 14: ethereum.eth.v1.BeaconStateResponse.data:type_name -> ethereum.eth.v1.BeaconState
