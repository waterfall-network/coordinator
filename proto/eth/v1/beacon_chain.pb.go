...
var file_proto_eth_v1_beacon_chain_proto_rawDesc = []byte{
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x56, 0x0a, 0x1a, 0x56, 0x6f, 0x6c, 0x75, 0x6e, 0x74, 0x61,
	0x72, 0x79, 0x45, 0x78, 0x69, 0x74, 0x73, 0x50, 0x6f, 0x6f, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x38, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x03, 0x28,
	...
	0x61, 0x72, 0x79, 0x45, 0x78, 0x69, 0x74, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x41, 0x0a,
	...
	0x22, 0x55, 0x0a, 0x18, 0x57, 0x65, 0x61, 0x6b, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x69,
	...
	0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x77, 0x0a, 0x14, 0x57, 0x65, 0x61, 0x6b, 0x53,
	...
	0x42, 0x93, 0x01, 0x0a, 0x13, 0x6f, 0x72, 0x67, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75,
	0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x42, 0x10, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e,
	0x43, 0x68, 0x61, 0x69, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x44, 0x67, 0x69,
	...
	0x6e, 0x61, 0x74, 0x6f, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x65, 0x74, 0x68, 0x2f,
...
var file_proto_eth_v1_beacon_chain_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_proto_eth_v1_beacon_chain_proto_goTypes = []interface{}{
	...
	(*ForkScheduleResponse)(nil),                                    // 38: ethereum.eth.v1.ForkScheduleResponse
	(*SpecResponse)(nil),                                            // 39: ethereum.eth.v1.SpecResponse
	(*DepositContractResponse)(nil),                                 // 40: ethereum.eth.v1.DepositContractResponse
	(*DepositContract)(nil),                                         // 41: ethereum.eth.v1.DepositContract
	(*WeakSubjectivityResponse)(nil),                                // 42: ethereum.eth.v1.WeakSubjectivityResponse
	(*WeakSubjectivityData)(nil),                                    // 43: ethereum.eth.v1.WeakSubjectivityData
	...
	(*BlockVoting)(nil),           // 51: ethereum.eth.v1.BlockVoting
	(*Eth1Data)(nil),              // 52: ethereum.eth.v1.Eth1Data
	(*Committee)(nil),             // 53: ethereum.eth.v1.Committee
	(*Attestation)(nil),           // 54: ethereum.eth.v1.Attestation
	(*SpineData)(nil),             // 55: ethereum.eth.v1.SpineData
	(*BeaconBlockHeader)(nil),     // 56: ethereum.eth.v1.BeaconBlockHeader
	(*BeaconBlock)(nil),           // 57: ethereum.eth.v1.BeaconBlock
	(*AttesterSlashing)(nil),      // 58: ethereum.eth.v1.AttesterSlashing
	(*ProposerSlashing)(nil),      // 59: ethereum.eth.v1.ProposerSlashing
	(*SignedVoluntaryExit)(nil),   // 60: ethereum.eth.v1.SignedVoluntaryExit
	(*Checkpoint)(nil),            // 61: ethereum.eth.v1.Checkpoint
...
var file_proto_eth_v1_beacon_chain_proto_depIdxs = []int32{
	...
	51, // 7: ethereum.eth.v1.StateBlockVotingsResponse.data:type_name -> ethereum.eth.v1.BlockVoting
	52, // 8: ethereum.eth.v1.StateEth1DataResponse.data:type_name -> ethereum.eth.v1.Eth1Data
	50, // 9: ethereum.eth.v1.StateValidatorResponse.data:type_name -> ethereum.eth.v1.ValidatorContainer
	53, // 10: ethereum.eth.v1.StateCommitteesResponse.data:type_name -> ethereum.eth.v1.Committee
	54, // 11: ethereum.eth.v1.BlockAttestationsResponse.data:type_name -> ethereum.eth.v1.Attestation
	55, // 12: ethereum.eth.v1.StateSpineDataResponse.data:type_name -> ethereum.eth.v1.SpineData
	...
	56, // 17: ethereum.eth.v1.BeaconBlockHeaderContainer.message:type_name -> ethereum.eth.v1.BeaconBlockHeader
	31, // 18: ethereum.eth.v1.BlockResponse.data:type_name -> ethereum.eth.v1.BeaconBlockContainer
	57, // 19: ethereum.eth.v1.BeaconBlockContainer.message:type_name -> ethereum.eth.v1.BeaconBlock
	54, // 20: ethereum.eth.v1.SubmitAttestationsRequest.data:type_name -> ethereum.eth.v1.Attestation
	54, // 21: ethereum.eth.v1.AttestationsPoolResponse.data:type_name -> ethereum.eth.v1.Attestation
	58, // 22: ethereum.eth.v1.AttesterSlashingsPoolResponse.data:type_name -> ethereum.eth.v1.AttesterSlashing
	59, // 23: ethereum.eth.v1.ProposerSlashingPoolResponse.data:type_name -> ethereum.eth.v1.ProposerSlashing
	60, // 24: ethereum.eth.v1.VoluntaryExitsPoolResponse.data:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	48, // 25: ethereum.eth.v1.ForkScheduleResponse.data:type_name -> ethereum.eth.v1.Fork
	47, // 26: ethereum.eth.v1.SpecResponse.data:type_name -> ethereum.eth.v1.SpecResponse.DataEntry
	41, // 27: ethereum.eth.v1.DepositContractResponse.data:type_name -> ethereum.eth.v1.DepositContract
	43, // 28: ethereum.eth.v1.WeakSubjectivityResponse.data:type_name -> ethereum.eth.v1.WeakSubjectivityData
	61, // 29: ethereum.eth.v1.WeakSubjectivityData.ws_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	62, // 30: ethereum.eth.v1.GenesisResponse.Genesis.genesis_time:type_name -> google.protobuf.Timestamp
	61, // 31: ethereum.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint.previous_justified:type_name -> ethereum.eth.v1.Checkpoint
	61, // 32: ethereum.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint.current_justified:type_name -> ethereum.eth.v1.Checkpoint
	61, // 33: ethereum.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint.finalized:type_name -> ethereum.eth.v1.Checkpoint
