...
// Hash: e976204c368a149b5124cab5155f9ab17c82ef8adffc2605c22ccfcded3cc236
package v1
...
func (b *BeaconBlockBody) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o8:]
		num, err := ssz.DivideInt2(len(buf), 56, 1024)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.Withdrawals[ii].UnmarshalSSZ(buf[ii*56 : (ii+1)*56]); err != nil {
				return err
			}
		}
	}
...
func (w *Withdrawal) UnmarshalSSZ(buf []byte) error {
	...
	if cap(w.InitTxHash) == 0 {
		w.InitTxHash = make([]byte, 0, len(buf[24:56]))
	}
	w.InitTxHash = append(w.InitTxHash, buf[24:56]...)
...
func (v *Validator) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (9) 'Withdrawals'
	dst = ssz.MarshalUint64(dst, v.Withdrawals)
...
func (v *Validator) UnmarshalSSZ(buf []byte) error {
	...
	// Field (9) 'Withdrawals'
	v.Withdrawals = ssz.UnmarshallUint64(buf[129:137])
