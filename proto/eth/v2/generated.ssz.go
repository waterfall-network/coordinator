...
// Hash: df207bd1d56f38f7ff060bbbed50bf48d54cc369c004e2b190bf75fab693f995
package eth
...
func (b *BeaconBlockBodyBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	// Field (7) 'VoluntaryExits'
	{
		...
		b.VoluntaryExits = make([]*v1.VoluntaryExit, num)
		for ii := 0; ii < num; ii++ {
			if b.VoluntaryExits[ii] == nil {
				b.VoluntaryExits[ii] = new(v1.VoluntaryExit)
			}
